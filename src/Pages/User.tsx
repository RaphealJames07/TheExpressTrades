                    ...
                    <div className="h-[90vh] w-full overflow-y-auto scrollbar-thumb-[#341414] scrollbar-track-[#b76161] scrollbar-thin py-5 flex flex-col gap-5">
                        ...
                        <div className="w-full h-max flex flex-col gap-3 mt-6">
                            ...
                            <div className="w-full h-max flex flex-col gap-2">
                                <div className="w-full h-11 flex items-center text-white bg-[#7c3131] transition-all duration-400 gap-2 px-6 rounded-full cursor-pointer">
                                    <BsGrid className="w-6 h-6" />
                                    <p className="font-medium">Dashboard</p>
                                </div>
                                <div className="w-full h-11 flex items-center text-white transition-all duration-400 hover:bg-[#7c3131] gap-2 px-6 rounded-full cursor-pointer">
