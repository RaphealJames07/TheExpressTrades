...
const Footer = () => {
    return (
        <>
            <div className="bgimg px-24 pt-32 ">
                <div className="h-[70%] w-full flex justify-between gap-5 text-white">
                    <div className="w-[32%] h-full flex items-center flex-col gap-10">
                    ...
                    <div className="w-[16%] h-full flex flex-col gap-10">
                        <p className="text-2xl font-semibold">Company</p>
                        <div className="w-max h-max flex flex-col gap-5 text-lg">
